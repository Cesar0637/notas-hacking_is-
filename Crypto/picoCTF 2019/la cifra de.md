...
## Soluciòn
cuando ajecutamos el comando nc observamos un texto encriptado 
...
usando la herramienta llamada Vingere Solver.
Pegamos el texto  luego la longitud de la llave entre 3 y 15 damos click en  'Break Cipher'.
```text
y nos dara como resultado el texto decifrado y en una parte esta la bandera 
